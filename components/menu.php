<div class="burger" id="targetbutton">
        <span></span>
    </div>
    ...
    <nav>
        <ul class="main">
            ...
            <li><a href="solo.php">Solo Tournaments</a></li>
            <li><a href="squad.php">Squad Tournaments</a></li>
            <li><a href="all/about.html">About Us</a></li>
            <li><a href="all/contact-us.html">Contact Us</a></li>
        </ul>
        <div class="about">
            <p>NTR Esports is dedicated to creating a positive impact in the esports community.
            </p>
        </div>
        <div class="social">
            <a href="#0" target="_blank"><svg xmlns="http://www.w3.org/2000/svg"
            ...
            <a href="https://instagram.com/official.ntr_esports?igshid=ZDdkNTZiNTM=" target="_blank"><svg
